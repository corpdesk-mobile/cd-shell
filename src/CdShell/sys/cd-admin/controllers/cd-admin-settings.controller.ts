...
export class CdAdminSettingsController {
  form: CdFormGroup;
  binder: CdDirectiveBinderService;
  uiSystemLoader: UiSystemLoaderService;
  uiThemeLoader: UiThemeLoaderService;
  svCdAdmin!:CdAdminService;
  // Tracks the currently selected UI System ID locally
  private currentUiSystemId: string = "";
  ...
  async onUiSystemChange(e: Event): Promise<void> {
    const value = (e.target as HTMLSelectElement).value;
    console.log("🧩 UI System changed:", value);
  }

  async onThemeChange(e: Event): Promise<void> {
    const value = (e.target as HTMLSelectElement).value;
    console.log("🎨 Theme changed:", value);
  }

  async onFormVariantChange(e: Event): Promise<void> {
    const value = (e.target as HTMLSelectElement).value;
  ...
  get uiSystemOptionsHtml(): string {
  ...
  /**
     ...
     */
    get formVariantOptionsHtml(): string {
