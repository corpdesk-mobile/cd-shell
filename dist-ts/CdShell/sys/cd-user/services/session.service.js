...
export class SessionService extends GenericService {
    ...
    async getSessionDataExt(req, res, ignoreCache) {
        ...
        this.currentSessData = sessResult.data;
        let consumerGuid = '';
        ...
        const consumerData = await svConsumer.getCompanyData(req, res, consumerGuid);
        if (consumerData) {
