...
export class GroupService extends GenericService {
    ...
    async getModuleGroup(req, res, moduleName) {
        const serviceInput = {
        ...
        return resultModGroup.data;
    }
    getModuleGroup$(req, res, moduleName) {
        const serviceInput = {
            serviceModel: GroupModel,
            docName: 'GroupService::getGroupByName',
            cmd: {
    ...
    // }
    async createPalsGroup(req, res, userData) {
        ...
        const consumerData = await svConsumer.getConsumerByGuid(req, res, consGuid);
        ...
        const co = await svCompany.getCompanyI(req, res, {
    ...
    async groupExists(req, res, params) {
        let ret = false;
        const serviceInput = {
            serviceInstance: this,
            serviceModel: GroupModel,
