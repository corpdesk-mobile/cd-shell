 ...
 */
export function toCamelMain(str) {
    if (!str)
        return str;
    return str
        .split('-')
 ...
 */
export function toCamelMinor(str) {
    if (!str)
        return str;
    const pascal = str
        .split('-')
 ...
 */
export function toUniversalSnakeCase(input) {
    return input
 ...
 */
export function inferCdObjType(source) {
...
export function isVisitorField(fieldSnake) {
    return (fieldSnake.endsWith('_id') &&
...
export function injectTypeBeforeSuffix(original, suffixes = ['Id', 'Guid', 'Code', 'Ref', 'Name', 'Description', 'Enabled'], injection = 'Type') {
...
export function injectTypeBeforeSnakeSuffix(original, suffixes = ['_id', '_guid', '_code', '_ref', '_name', '_description', '_enabled'], injection = '_type') {
