...
export class QueryBuilderHelper {
    ...
    createQueryBuilder(serviceInput) {
    ...
    /**
       ...
       * @param where
       */
    processObjectWhereClause(queryBuilder, where) {
    ...
    processArrayWhereClause2(queryBuilder, where) {
    ...
    processArrayWhereClause(queryBuilder, whereArray) {
    ...
    updateJSONField(jsonField, updates) {
