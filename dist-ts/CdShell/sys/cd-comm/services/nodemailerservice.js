...
export class NodemailerService {
     ...
     * @param res
     */
    async sendMail(req, res, msg, recepientUser) {
        console.info('starting NodemailerService::sendMail()');
        console.info('NodemailerService::sendMail()/msg:', msg);
        console.info('NodemailerService::sendMail()/emailUser:', config.emailUsers[0]);
