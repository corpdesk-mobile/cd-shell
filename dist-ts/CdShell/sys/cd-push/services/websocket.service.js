...
const socketsStore = [];
export class WebsocketService extends GenericService {
    constructor() {
        super();
    ...
    getWebSocketCount(req, res, serviceInput) {
        const q = this.b.getQuery(req);
    ...
    async getSocketRedis(rg) {
        ...
        const socketData = JSON.parse(socketStr.r);
