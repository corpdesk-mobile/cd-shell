...
export class CoopTypeService {
    ...
    async create(req, res) {
        console.info('CoopTypecreate::validateCreate()/01');
        ...
        if (await this.validateCreate(req, res)) {
            ...
            console.info('CoopTypeService::create()/serviceInput:', serviceInput);
            ...
            console.info('CoopTypecreate::validateCreate()/02');
            const r = await this.b.respond(req, res);
        }
    }
    ...
    async createM(req, res) {
        console.info('CoopTypeService::createM()/01');
        let data = req.post.dat.f_vals[0].data;
        console.info('CoopTypeService::createM()/data:', data);
        ...
        for (var coopData of data) {
            ...
            console.info('CoopTypeService::createM()/forLoop/ret:', {
                ret: ret,
            });
        }
    ...
    async readSL(req, res, serviceInput) {
        ...
        console.info('CoopTypeService::getCoopTypeq:', q);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CoopTypeService::read$()/r:', r)
            ...
            console.info('CoopTypeService::read$()/e:');
    ...
    update(req, res) {
        // console.info('CoopTypeService::update()/01');
        ...
        // console.info('CoopTypeService::update()/02')
    ...
    async validateCreate(req, res) {
        console.info('CoopTypeCoopTypeService::validateCreate()/01');
        const svSess = new SessionService();
        ///////////////////////////////////////////////////////////////////
        ...
        if (await this.b.validateUnique(req, res, params)) {
            console.info('CoopTypeCoopTypeService::validateCreate()/02');
            if (await this.b.validateRequired(req, res, this.cRules)) {
                console.info('CoopTypeCoopTypeService::validateCreate()/03');
                ret = true;
            }
            else {
                console.info('CoopTypeCoopTypeService::validateCreate()/04');
                ret = false;
            ...
            console.info('CoopTypeCoopTypeService::validateCreate()/05');
            ret = false;
            this.b.i.app_msg = `duplicate for ${this.cRules.noDuplicate.join(', ')} is not allowed`;
            this.b.err.push(this.b.i.app_msg);
            this.b.setAppState(false, this.b.i, svSess.sessResp);
        }
        console.info('CoopTypeCoopTypeService::validateCreate()/06');
        ///////////////////////////////////////////////////////////////////
        // 2. confirm the coopTypeId referenced exists
        // const pl: CoopTypeModel = this.b.getPlData(req);
        // if ('coopTypeId' in pl) {
        //     console.info('CoopTypeCoopTypeService::validateCreate()/07')
        //     console.info('CoopTypeCoopTypeService::validateCreate()/pl:', pl)
        //     const serviceInput = {
        //         serviceModel: CoopTypeModel,
        ...
        //         dSource: 1
        //     }
        //     console.info('CoopTypeCoopTypeService::validateCreate()/serviceInput:', JSON.stringify(serviceInput))
        //     const r: any = await this.b.read(req, res, serviceInput)
        //     console.info('CoopTypeCoopTypeService::validateCreate()/r:', r)
        //     if (r.length > 0) {
        //         console.info('CoopTypeCoopTypeService::validateCreate()/08')
        //         ret = true;
        //     } else {
        //         console.info('CoopTypeCoopTypeService::validateCreate()/10')
        //         ret = false;
        ...
        //     }
        // } else {
        //     console.info('CoopTypeCoopTypeService::validateCreate()/11')
        ...
        //     this.b.setAppState(false, this.b.i, svSess.sessResp);
        // }
        console.info('CoopTypeService::getCoopType12');
        if (this.b.err.length > 0) {
            console.info('CoopTypeCoopTypeService::validateCreate()/13');
            ret = false;
        }
        return ret;
    }
    ...
    async getCoop(req, res, q) {
        ...
        console.info('CoopTypeService::getCoop:', q);
        if (!q) {
            return;
        }
        const serviceInput = this.b.siGet(q, 'CoopTypeService::getCoop', CoopModel);
        try {
    ...
    async getCoopSL(req, res) {
        await this.b.initSqlite(req, res);
        const q = this.b.getQuery(req);
        console.info('CoopTypeService::getCoopSL:', q);
        const serviceInput = this.b.siGet(q, 'CoopTypeService::getCoopSL', CoopModel);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CoopTypeService::read$()/r:', r)
                this.b.i.code = 'CoopTypeService::getCoopSL';
                const svSess = new SessionService();
                svSess.sessResp.cd_token = req.post.dat.token;
                svSess.sessResp.ttl = svSess.getTtl();
                this.b.setAppState(true, this.b.i, svSess.sessResp);
            ...
            console.info('CoopTypeService::getCoopSL$()/e:');
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
                code: 'CoopTypeService:getCoopSL',
                app_msg: '',
            };
            await this.b.serviceErr(req, res, e, i.code);
            await this.b.respond(req, res);
    ...
    getCoopType(req, res) {
        const q = this.b.getQuery(req);
        console.info('CoopTypeService::getCoopTypef:', q);
        const serviceInput = {
            serviceModel: CoopTypeModel,
    ...
    getCoopCount(req, res) {
        const q = this.b.getQuery(req);
        console.info('CoopTypeService::getCoopCount/q:', q);
        const serviceInput = {
    ...
    delete(req, res) {
        const q = this.b.getQuery(req);
        console.info('CoopTypeService::delete()/q:', q);
        const serviceInput = {
            serviceModel: CoopTypeModel,
    ...
    deleteSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CoopTypeService::deleteSL()/q:', q);
        const serviceInput = {
            serviceModel: CoopTypeModel,
