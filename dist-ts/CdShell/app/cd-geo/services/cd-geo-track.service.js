...
import { CdGeoTrackModel } from '../models/cd-geo-track.model.js';
...
export class CdGeoTrackService {
    constructor() {
        this.modelName = 'CdGeoTrackModel';
    ...
    async create(req, res) {
        console.info('cd-geo-track/create::validateCreate()/01');
        ...
        if (await this.validateCreate(req, res)) {
            ...
            console.info('CdGeoTrackService::create()/serviceInput:', serviceInput);
            ...
            console.info('cd-geo-track/create::validateCreate()/02');
            const r = await this.b.respond(req, res);
        }
    }
    ...
    async createM(req, res) {
        console.info('CdGeoTrackService::createM()/01');
        let data = req.post.dat.f_vals[0].data;
        console.info('CdGeoTrackService::createM()/data:', data);
        // this.b.models.push(CdGeoTrackModel)
        // this.b.init(req, res)
        for (var CdGeoTrackData of data) {
            console.info('CdGeoTrackData', CdGeoTrackData);
            const CdGeoTrackQuery = CdGeoTrackData;
            ...
            console.info('CdGeoTrackService::createM()/forLoop/ret:', {
                ret: ret,
            });
        }
    ...
    async CdGeoTrackExists(req, res, params) {
        const serviceInput = {
            serviceInstance: this,
            serviceModel: CdGeoTrackModel,
    ...
    async read(req, res, serviceInput) {
        // const serviceInput: IServiceInput<CdGeoTrackModel> = {
        //     serviceInstance: this,
        //     serviceModel: CdGeoTrackModel,
        //     docName: 'CdGeoTrackService::CdGeoTrackExists',
        //     cmd: {
    ...
    async readSL(req, res, serviceInput) {
        ...
        console.info('CdGeoTrackService::getCdGeoTrack/q:', q);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CdGeoTrackService::read$()/r:', r)
            ...
            // console.info('CdGeoTrackService::read$()/e:', e);
    ...
    update(req, res) {
        // console.info('CdGeoTrackService::update()/01');
        ...
        // console.info('CdGeoTrackService::update()/02')
    ...
    async validateCreate(req, res) {
        console.info('cd-geo-track/CdGeoTrackService::validateCreate()/01');
        const svSess = new SessionService();
        ///////////////////////////////////////////////////////////////////
        ...
        if (await this.b.validateUnique(req, res, params)) {
            console.info('cd-geo-track/CdGeoTrackService::validateCreate()/02');
            if (await this.b.validateRequired(req, res, this.cRules)) {
                console.info('cd-geo-track/CdGeoTrackService::validateCreate()/03');
                ret = true;
            }
            else {
                console.info('cd-geo-track/CdGeoTrackService::validateCreate()/04');
                ret = false;
            ...
            console.info('cd-geo-track/CdGeoTrackService::validateCreate()/05');
            ret = false;
            this.b.i.app_msg = `duplicate for ${this.cRules.noDuplicate.join(', ')} is not allowed`;
            this.b.err.push(this.b.i.app_msg);
            this.b.setAppState(false, this.b.i, svSess.sessResp);
        }
        console.info('cd-geo-track/CdGeoTrackService::validateCreate()/06');
        ///////////////////////////////////////////////////////////////////
        // 2. confirm the CdGeoTrackTypeId referenced exists
        // const pl: CdGeoTrackModel = this.b.getPlData(req);
        // if ('CdGeoTrackTypeId' in pl) {
        //     console.info('cd-geo-track/CdGeoTrackService::validateCreate()/07')
        //     console.info('cd-geo-track/CdGeoTrackService::validateCreate()/pl:', pl)
        //     const serviceInput = {
        ...
        //         dSource: 1
        //     }
        //     console.info('cd-geo-track/CdGeoTrackService::validateCreate()/serviceInput:', JSON.stringify(serviceInput))
        //     const r: any = await this.b.read(req, res, serviceInput)
        //     console.info('cd-geo-track/CdGeoTrackService::validateCreate()/r:', r)
        //     if (r.length > 0) {
        //         console.info('cd-geo-track/CdGeoTrackService::validateCreate()/08')
        //         ret = true;
        //     } else {
        //         console.info('cd-geo-track/CdGeoTrackService::validateCreate()/10')
        //         ret = false;
        ...
        //     }
        // } else {
        //     console.info('cd-geo-track/CdGeoTrackService::validateCreate()/11')
        ...
        //     this.b.setAppState(false, this.b.i, svSess.sessResp);
        // }
        console.info('CdGeoTrackService::getCdGeoTrack/12');
        if (this.b.err.length > 0) {
            console.info('cd-geo-track/CdGeoTrackService::validateCreate()/13');
            ret = false;
        }
        return ret;
    }
    ...
    async getCdGeoTrack(req, res, q) {
        ...
        console.info('CdGeoTrackService::getCdGeoTrack/f:', q);
        const serviceInput = this.b.siGet(q, 'CdGeoTrackService::getCdGeoTrack', CdGeoTrackModel);
        try {
            ...
            const i = {
                messages: this.b.err,
                code: 'CdGeoTrackService:getCdGeoTrack',
                app_msg: '',
            };
            await this.b.serviceErr(req, res, e, i.code);
            await this.b.respond(req, res);
     ...
     * @param q
     */
    async getCdGeoTrackStats(req, res, q) {
        if (q === null) {
            q = this.b.getQuery(req);
        }
        if (!q) {
    ...
    async getCdGeoTrackSL(req, res) {
        ...
        const q = this.b.getQuery(req);
        console.info('CdGeoTrackService::getCdGeoTrack/q:', q);
        const serviceInput = this.b.siGet(q, 'CdGeoTrackService::getCdGeoTrackSL', CdGeoTrackModel);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CdGeoTrackService::read$()/r:', r)
                this.b.i.code = 'CdGeoTrackService::Get';
    ...
    //  * @param res
    //  */
    // getCdGeoTrackType(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoTrackService::getCdGeoTrack/f:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoTrackTypeModel,
    ...
    getPagedSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTrackService::getCdGeoTrackCount()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTrackModel,
    ...
    // getCdGeoTrackTypeCount(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoTrackService::getCdGeoTrackCount/q:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoTrackTypeModel,
    ...
    delete(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTrackService::delete()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTrackModel,
    ...
    deleteSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTrackService::deleteSL()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTrackModel,
