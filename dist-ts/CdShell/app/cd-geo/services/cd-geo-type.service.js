...
import { CdGeoTypeModel } from '../models/cd-geo-type.model.js';
...
export class CdGeoTypeService {
    ...
    async create(req, res) {
        console.info('cd-geo-type/create::validateCreate()/01');
        ...
        if (await this.validateCreate(req, res)) {
            ...
            console.info('CdGeoTypeService::create()/serviceInput:', serviceInput);
            ...
            console.info('cd-geo-type/create::validateCreate()/02');
            const r = await this.b.respond(req, res);
        }
    }
    ...
    async createM(req, res) {
        console.info('CdGeoTypeService::createM()/01');
        let data = req.post.dat.f_vals[0].data;
        console.info('CdGeoTypeService::createM()/data:', data);
        // this.b.models.push(CdGeoTypeModel)
        // this.b.init(req, res)
        for (var CdGeoTypeData of data) {
            console.info('CdGeoTypeData', CdGeoTypeData);
            const CdGeoTypeQuery = CdGeoTypeData;
            ...
            console.info('CdGeoTypeService::createM()/forLoop/ret:', {
                ret: ret,
            });
        }
    ...
    async CdGeoTypeExists(req, res, params) {
        const serviceInput = {
            serviceInstance: this,
            serviceModel: CdGeoTypeModel,
    ...
    async read(req, res, serviceInput) {
        // const serviceInput: IServiceInput<CdGeoTypeModel> = {
        //     serviceInstance: this,
        //     serviceModel: CdGeoTypeModel,
        //     docName: 'CdGeoTypeService::CdGeoTypeExists',
        //     cmd: {
    ...
    async readSL(req, res, serviceInput) {
        ...
        console.info('CdGeoTypeService::getCdGeoType/q:', q);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CdGeoTypeService::read$()/r:', r)
            ...
            // console.info('CdGeoTypeService::read$()/e:', e);
    ...
    update(req, res) {
        // console.info('CdGeoTypeService::update()/01');
        ...
        // console.info('CdGeoTypeService::update()/02')
    ...
    async validateCreate(req, res) {
        console.info('cd-geo-type/CdGeoTypeService::validateCreate()/01');
        const svSess = new SessionService();
        ///////////////////////////////////////////////////////////////////
        ...
        if (await this.b.validateUnique(req, res, params)) {
            console.info('cd-geo-type/CdGeoTypeService::validateCreate()/02');
            if (await this.b.validateRequired(req, res, this.cRules)) {
                console.info('cd-geo-type/CdGeoTypeService::validateCreate()/03');
                ret = true;
            }
            else {
                console.info('cd-geo-type/CdGeoTypeService::validateCreate()/04');
                ret = false;
            ...
            console.info('cd-geo-type/CdGeoTypeService::validateCreate()/05');
            ret = false;
            this.b.i.app_msg = `duplicate for ${this.cRules.noDuplicate.join(', ')} is not allowed`;
            this.b.err.push(this.b.i.app_msg);
            this.b.setAppState(false, this.b.i, svSess.sessResp);
        }
        console.info('cd-geo-type/CdGeoTypeService::validateCreate()/06');
        ///////////////////////////////////////////////////////////////////
        // 2. confirm the CdGeoTypeId referenced exists
        // const pl: CdGeoTypeModel = this.b.getPlData(req);
        // if ('CdGeoTypeId' in pl) {
        //     console.info('cd-geo-type/CdGeoTypeService::validateCreate()/07')
        //     console.info('cd-geo-type/CdGeoTypeService::validateCreate()/pl:', pl)
        //     const serviceInput = {
        //         serviceModel: CdGeoTypeModel,
        ...
        //         dSource: 1
        //     }
        //     console.info('cd-geo-type/CdGeoTypeService::validateCreate()/serviceInput:', JSON.stringify(serviceInput))
        //     const r: any = await this.b.read(req, res, serviceInput)
        //     console.info('cd-geo-type/CdGeoTypeService::validateCreate()/r:', r)
        //     if (r.length > 0) {
        //         console.info('cd-geo-type/CdGeoTypeService::validateCreate()/08')
        //         ret = true;
        //     } else {
        //         console.info('cd-geo-type/CdGeoTypeService::validateCreate()/10')
        //         ret = false;
        ...
        //     }
        // } else {
        //     console.info('cd-geo-type/CdGeoTypeService::validateCreate()/11')
        ...
        //     this.b.setAppState(false, this.b.i, svSess.sessResp);
        // }
        console.info('CdGeoTypeService::getCdGeoType/12');
        if (this.b.err.length > 0) {
            console.info('cd-geo-type/CdGeoTypeService::validateCreate()/13');
            ret = false;
        }
        return ret;
    }
    ...
    async getCdGeoType(req, res, q) {
        ...
        console.info('CdGeoTypeService::getCdGeoType/f:', q);
        const serviceInput = this.b.siGet(q, 'CdGeoTypeService::getCdGeoType', CdGeoTypeModel);
        try {
     ...
     * @param q
     */
    async getCdGeoTypeStats(req, res, q) {
        if (q === null) {
            q = this.b.getQuery(req);
        }
        if (!q) {
    ...
    //  *
    //  * curl test:
    //  * curl -k -X POST -H 'Content-Type: application/json' -d '{"ctx": "App","m": "CdGeoTypes","c": "CdGeoType","a": "GetType","dat":{"f_vals": [{"query":{"where": {"CdGeoTypeId":100}}}],"token":"08f45393-c10e-4edd-af2c-bae1746247a1"},"args": null}' http://localhost:3001 -v  | jq '.'
    //  * @param req
    //  * @param res
    //  */
    // getCdGeoType(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoTypeService::getCdGeoType/f:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoTypeModel,
    ...
    getPagedSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTypeService::getCdGeoTypeCount()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTypeModel,
    ...
    // getCdGeoTypeCount(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoTypeService::getCdGeoTypeCount/q:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoTypeModel,
    ...
    delete(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTypeService::delete()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTypeModel,
    ...
    deleteSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoTypeService::deleteSL()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoTypeModel,
