...
import { CD_FX_FAIL, } from '../../../sys/base/i-base.js';
import { CdGeoLocationModel } from '../models/cd-geo-location.model.js';
import { CdGeoLocationViewModel } from '../models/cd-geo-location-view.model.js';
...
export class CdGeoLocationService {
    ...
    async create(req, res) {
        console.info('cd-geo-location/create::validateCreate()/01');
        ...
        if (await this.validateCreate(req, res)) {
            ...
            console.info('CdGeoLocationService::create()/serviceInput:', serviceInput);
            ...
            console.info('cd-geo-location/create::validateCreate()/02');
            const r = await this.b.respond(req, res);
        }
    }
    ...
    async createM(req, res) {
        console.info('CdGeoLocationService::createM()/01');
        let data = req.post.dat.f_vals[0].data;
        console.info('CdGeoLocationService::createM()/data:', data);
        // this.b.models.push(CdGeoLocationModel)
        // this.b.init(req, res)
        for (var CdGeoLocationData of data) {
            console.info('CdGeoLocationData', CdGeoLocationData);
            const CdGeoLocationQuery = CdGeoLocationData;
            ...
            console.info('CdGeoLocationService::createM()/forLoop/ret:', {
                ret: ret,
            });
        }
    ...
    async read(req, res, serviceInput) {
        // const serviceInput: IServiceInput<CdGeoLocationModel> = {
        //     serviceInstance: this,
        //     serviceModel: CdGeoLocationModel,
    ...
    async CdGeoLocationExists(req, res, params) {
        const serviceInput = {
            serviceInstance: this,
            serviceModel: CdGeoLocationModel,
            docName: 'CdGeoLocationService::CdGeoLocationExists',
    ...
    async validateGeoLocation(req, res, q) {
        const svCdGeoLocation = new CdGeoLocationService();
        const serviceInput = {
            serviceInstance: this,
        ...
        const locations = await svCdGeoLocation.read(req, res, serviceInput);
    ...
    async readSL(req, res, serviceInput) {
        ...
        console.info('CdGeoLocationService::getCdGeoLocation/q:', q);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.info('CdGeoLocationService::read$()/r:', r)
            ...
            // console.info('CdGeoLocationService::read$()/e:', e);
    ...
    update(req, res) {
        // console.info('CdGeoLocationService::update()/01');
        ...
        // console.info('CdGeoLocationService::update()/02')
    ...
    async validateCreate(req, res) {
        console.info('cd-geo-location/CdGeoLocationService::validateCreate()/01');
        const svSess = new SessionService();
        ///////////////////////////////////////////////////////////////////
        ...
        if (await this.b.validateUnique(req, res, params)) {
            console.info('cd-geo-location/CdGeoLocationService::validateCreate()/02');
            if (await this.b.validateRequired(req, res, this.cRules)) {
                console.info('cd-geo-location/CdGeoLocationService::validateCreate()/03');
                ret = true;
            }
            else {
                console.info('cd-geo-location/CdGeoLocationService::validateCreate()/04');
                ret = false;
            ...
            console.info('cd-geo-location/CdGeoLocationService::validateCreate()/05');
            ret = false;
            this.b.i.app_msg = `duplicate for ${this.cRules.noDuplicate.join(', ')} is not allowed`;
            this.b.err.push(this.b.i.app_msg);
            this.b.setAppState(false, this.b.i, svSess.sessResp);
        }
        console.info('cd-geo-location/CdGeoLocationService::validateCreate()/06');
        ///////////////////////////////////////////////////////////////////
        ...
        //     console.info('cd-geo-location/CdGeoLocationService::validateCreate()/07')
        //     console.info('cd-geo-location/CdGeoLocationService::validateCreate()/pl:', pl)
        //     const serviceInput = {
        ...
        //         dSource: 1
        //     }
        //     console.info('cd-geo-location/CdGeoLocationService::validateCreate()/serviceInput:', JSON.stringify(serviceInput))
        //     const r: any = await this.b.read(req, res, serviceInput)
        //     console.info('cd-geo-location/CdGeoLocationService::validateCreate()/r:', r)
        //     if (r.length > 0) {
        //         console.info('cd-geo-location/CdGeoLocationService::validateCreate()/08')
        //         ret = true;
        //     } else {
        //         console.info('cd-geo-location/CdGeoLocationService::validateCreate()/10')
        //         ret = false;
        ...
        //     }
        // } else {
        //     console.info('cd-geo-location/CdGeoLocationService::validateCreate()/11')
        ...
        //     this.b.setAppState(false, this.b.i, svSess.sessResp);
        // }
        console.info('CdGeoLocationService::getCdGeoLocation/12');
        if (this.b.err.length > 0) {
            console.info('cd-geo-location/CdGeoLocationService::validateCreate()/13');
            ret = false;
        }
        return ret;
    }
     ...
     * @param q
     */
    async getCdGeoLocation(req, res, q) {
        if (q === null) {
            q = this.b.getQuery(req);
        }
        console.info('CdGeoLocationService::getCdGeoLocation/f:', q);
        console.info('CdGeoLocationService::this.serviceModel:', this.serviceModel);
        if (!q) {
            return;
        }
        this.serviceModel = new CdGeoLocationModel();
        const serviceInput = this.b.siGet(q, 'CdGeoLocationService::getCdGeoLocation', CdGeoLocationModel);
        serviceInput.serviceModelInstance = this.serviceModel;
        serviceInput.serviceModel = CdGeoLocationModel;
        console.info('CdGeoLocationService::serviceInput:', this.serviceModel);
        try {
     ...
     * @param q
     */
    async getCdGeoLocationStats(req, res, q) {
        if (q === null) {
            q = this.b.getQuery(req);
        }
        console.info('CdGeoLocationService::getCdGeoLocation/f:', q);
    ...
    //  * @param res
    //  */
    // getCdGeoLocationType(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoLocationService::getCdGeoLocation/f:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoLocationTypeModel,
    ...
    getPagedSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoLocationService::getCdGeoLocationCount()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoLocationModel,
    ...
    // getCdGeoLocationTypeCount(req: any, res: any) {
    //     const q = this.b.getQuery(req);
    //     console.info('CdGeoLocationService::getCdGeoLocationCount/q:', q);
    //     const serviceInput = {
    //         serviceModel: CdGeoLocationTypeModel,
    ...
    delete(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoLocationService::delete()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoLocationModel,
    ...
    deleteSL(req, res) {
        const q = this.b.getQuery(req);
        console.info('CdGeoLocationService::deleteSL()/q:', q);
        const serviceInput = {
            serviceModel: CdGeoLocationModel,
    ...
    async GetContinent(req, res) {
        ...
        console.info('cd-geo-location/Continentscountriescities_Country()/queryStr:', { queryStr: queryStr });
        const fi = {
        ...
        console.info('cd-geo-location/SubdivisionStatesProvinces()/01');
        const svSess = new SessionService();
        const serviceInput = {
            serviceModel: CdGeoLocationModel,
            modelName: 'CdGeoLocationModel',
    ...
    async SubdivisionStatesProvinces(req, res) {
        const q = this.b.getQuery(req);
        let queryStr = `/classes/${q.class}?where=${JSON.stringify(q.where)}&skip=${q.skip}&limit=${q.take}&order=${q.order}`;
        console.info('cd-geo-location/SubdivisionStatesProvinces()/queryStr:', { queryStr: queryStr });
        const fi = {
            url: config.back4app.url + queryStr,
            optins: {
                headers: {
    ...
    async getGeoLocationI(req, res, q) {
        if (q === null) {
            q = this.b.getQuery(req);
        }
        console.info('CdGeoLocationService::getGeoLocationI/q:', q);
        let serviceModel = new CdGeoLocationModel();
        if (!q) {
            return CD_FX_FAIL;
        }
        const serviceInput = this.b.siGet(q, 'CdGeoLocationService::getGeoLocationI', CdGeoLocationModel);
        serviceInput.serviceModelInstance = serviceModel;
        serviceInput.serviceModel = CdGeoLocationModel;
        try {
            let respData = (await this.b.read(req, res, serviceInput));
            return { state: true, data: respData, message: '' };
        }
        catch (e) {
            // console.info('CdGeoLocationService::getGeoLocationI()/e:', e);
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
    ...
    async getCountriesInContinent(req, res, continentId) {
    ...
    async getGeoPoliticalTypeI(req, res, q) {
        const b = new BaseService();
        if (q === null) {
            q = this.b.getQuery(req);
        }
        console.info('CdGeoLocationService::getGeoPoliticalTypeI/q:', q);
        let serviceModel = new CdGeoPoliticalTypeModel();
        if (!q) {
            return CD_FX_FAIL;
        }
        const serviceInput = b.siGet(q, 'CdGeoLocationService::getGeoPoliticalTypeI', CdGeoPoliticalTypeModel);
        serviceInput.serviceModelInstance = serviceModel;
        serviceInput.serviceModel = CdGeoPoliticalTypeModel;
        try {
            let respData = (await b.read(req, res, serviceInput));
            return { state: true, data: respData, message: '' };
        }
        catch (e) {
            // console.info('CdGeoLocationService::getGeoPoliticalTypeI()/e:', e);
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
            ...
            return { state: true, data: null, message: e.toString() };
        }
    }
}
