...
export class CdGeoService {
    ...
    async CdGeoExists(req, res, params) {
        const serviceInput = {
            serviceInstance: this,
            serviceModel: CdGeoModel,
    ...
    async read(req, res, serviceInput) {
        // const serviceInput: IServiceInput<CdGeoModel> = {
        //     serviceInstance: this,
        //     serviceModel: CdGeoModel,
        //     docName: 'CdGeoService::CdGeoExists',
        //     cmd: {
    ...
    async getCdGeo(req, res, q) {
        ...
        const serviceInput = this.b.siGet(q, 'CdGeoService::getCdGeo', CdGeoModel);
        try {
            const r = await this.b.read(req, res, serviceInput);
    ...
    async getCdGeoStats(req, res, q) {
        ...
        console.log('CdGeoService::getCdGeoStats/f:', q);
        const serviceInput = this.b.siGet(q, 'CdGeoService::getCdGeo', CdGeoModel);
        try {
            const r = await this.b.read(req, res, serviceInput);
            this.b.successResponse(req, res, r);
            ...
            const i = {
                messages: this.b.err,
                code: 'BaseService:getCdGeoStats',
                app_msg: '',
            };
            await this.b.serviceErr(req, res, e, i.code);
            await this.b.respond(req, res);
    ...
    async getCdGeoSL(req, res) {
        ...
        console.log('CdGeoService::getCdGeoSL/q:', q);
        const serviceInput = this.b.siGet(q, 'CdGeoService::getCdGeoSL', CdGeoModel);
        try {
            this.b.readSL$(req, res, serviceInput).subscribe((r) => {
                // console.log('CdGeoService::read$()/r:', r)
                this.b.i.code = 'CdGeoService::getCdGeoSL';
                const svSess = new SessionService();
                svSess.sessResp.cd_token = req.post.dat.token;
                svSess.sessResp.ttl = svSess.getTtl();
                this.b.setAppState(true, this.b.i, svSess.sessResp);
            ...
            console.log('CdGeoService::getCdGeoSL()/e:', e);
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
                code: 'CdGeoService:update',
