const e={username:"",password:"",__template(){return`
    ...
    `},__setup(){console.log("[cd-user] Controller setup complete")},auth(){console.log("Auth triggered with:",this.username,this.password),alert(`Hello, ${this.username}!`)}},o={ctx:"app",moduleId:"coops",moduleName:"Auto-Generated Module",moduleGuid:"auto-guid",controller:e,template:e.__template(),menu:[]},t=o;export{o as coopsModule,t as module};
